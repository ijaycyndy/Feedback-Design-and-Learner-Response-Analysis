...
https://github.com/ijaycyndy/Multi-Persona-AI-Writing-Assistant

Project 2: Learning Analytics Dashboard for Writing Improvement
Focus on before-and-after writing changes
https://github.com/ijaycyndy/Learning-Analytics-Dashboard-for-Writing-Improvement

This project completes the pipeline by analysing feedback design impact.

## Notes on Scope

1) Small exploratory dataset

2) Results are illustrative, not generalisable

3) Emphasis is on method, reasoning, and evaluation design
